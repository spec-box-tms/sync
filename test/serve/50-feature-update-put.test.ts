...
specTest('serve-feature-update-put', 'PUT /api/features/:code/yaml', 'Успешное сохранение', 'PUT /api/features/:code/yaml сохраняет ошибки YAML, неразрешённые ссылки и повторные названия assert или propose и возвращает их в diagnostics нового ProjectSnapshot', () => withServer(async (url) => {
